                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} md="12" controlId="validationFormik03">
                            ...
                            <Form.Control
                                ...
                                onChange={handleChange}
                            />
                            <Button variant = "outline-secondary" onClick={()=> setpasswordIsVisible(prevState =>!prevState)}>
                               
                               {passwordIsVisible ? <FaEyeSlash/> : <FaEye/>}
                            </Button>
                            </InputGroup>
...
//Yup est une bibliothèque de validation de schéma JavaScript. Il est souvent utilisé avec Formik pour valider les données de formulaire avant la soumission. Yup fournit des méthodes de validation pour les types de données courants tels que les chaînes de caractères, les nombres, les tableaux, les objets, les dates, etc. Il permet également de définir des validations personnalisées en créant des schémas de validation. En utilisant Yup avec Formik, il est possible de valider les données saisies dans les champs de formulaire en temps réel et d'afficher des messages d'erreur appropriés aux utilisateurs.